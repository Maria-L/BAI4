...
public TreeAdaptor getTreeAdaptor() {
    ...
    // $ANTLR start "start"
    // Z:\\Projekte\\BAI4\\Compiler und Interpreter\\Praktikum 2\\symbolTreeGrammar.g:14:1: start : line line line column column column ;
    ...
    // $ANTLR start "line"
    // Z:\\Projekte\\BAI4\\Compiler und Interpreter\\Praktikum 2\\symbolTreeGrammar.g:17:1: line : ( ^( LINE firstOp ADD secondOp EQ thirdOp ) -> ^( LINE firstOp ADD[\"+\"] secondOp EQ thirdOp ) | ^( LINE firstOp SUB secondOp EQ thirdOp ) -> ^( LINE secondOp ADD[\"+\"] thirdOp EQ firstOp ) );
        ...
        try {
            ...
            switch (alt1) {
                ...
                case 2 :
                    ...
                    // AST REWRITE
                    // elements: LINE, secondOp, thirdOp, EQ, firstOp
                    // token labels: 
                    // rule labels: retval
                    // token list labels: 
                    // rule list labels: 
    ...
    // $ANTLR start "column"
    // Z:\\Projekte\\BAI4\\Compiler und Interpreter\\Praktikum 2\\symbolTreeGrammar.g:21:1: column : ( ^( COLUMN firstOp ADD secondOp EQ thirdOp ) -> ^( COLUMN firstOp ADD[\"+\"] secondOp EQ thirdOp ) | ^( COLUMN firstOp SUB secondOp EQ thirdOp ) -> ^( COLUMN secondOp ADD[\"+\"] thirdOp EQ firstOp ) );
    ...
    // $ANTLR start "firstOp"
    // Z:\\Projekte\\BAI4\\Compiler und Interpreter\\Praktikum 2\\symbolTreeGrammar.g:25:1: firstOp : ^( SIGN ( BCHAR )+ ) ;
    ...
    // Z:\\Projekte\\BAI4\\Compiler und Interpreter\\Praktikum 2\\symbolTreeGrammar.g:28:1: secondOp : ^( SIGN ( BCHAR )+ ) ;
    ...
    // $ANTLR start "thirdOp"
    // Z:\\Projekte\\BAI4\\Compiler und Interpreter\\Praktikum 2\\symbolTreeGrammar.g:31:1: thirdOp : ^( SIGN ( BCHAR )+ ) ;
